...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Forest animal  </a>  </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <select name="forestid" id="forestid">
                  <?php
                  $sql = "SELECT concat(forest_id,',',forest_name,',',forest_state) as forestdetail,forest_id from tbl_forest";
