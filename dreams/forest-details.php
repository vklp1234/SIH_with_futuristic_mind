    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="offcanvas__menu mobile-menu">
            <ul>
                ...
                <li><a href="./contact.php"> <i class="fa fa-edit"></i> Contact</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="#"><i class="fa fa-tree"></i> Forest</a>
                                <ul class="dropdown">
                                    <li><a href="./about.php">Forest Details</a></li>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="blog__item">
                                        ...
                                        <div class="blog__item__text">
                                            ...
                                            <h5><a href="#"><?php echo $data['forest_name']?></a></h5>
                                            <ul>
                        ...
                        for (var i = 0; i < res.size; i++) {
                            ...
                            '<div class="blog__item">'+
                                ...
                                '<div class="blog__item__text">'+
                                    ...
                                    '</ul>'+
                                    '<h5><a href="#">'+res.forest_name[i]+'</a></h5>'+
                                            '<ul>'+
